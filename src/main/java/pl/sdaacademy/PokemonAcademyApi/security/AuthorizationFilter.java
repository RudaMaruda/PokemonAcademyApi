...
//dla kazdego zadania bedziemy werfikowac czy zostal dodany token i czy jest on prawidlowy
...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public AuthorizationFilter(String headerKey, String signature, String tokenType, AuthenticationManager authenticationManager) {
    ...
    @Override
    //filtr weryfikujacy czy jest cos czy nie ma
